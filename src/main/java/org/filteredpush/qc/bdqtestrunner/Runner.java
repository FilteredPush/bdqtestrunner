...
public class Runner {
	...
	public static void main( String[] args ) {
		...
		options.addOption("c","classes",true,"List of classes containing test implementations to validate against the test data (default DwCMetadataDQ DwCGeoRefDQ DwCEventDQDefaults DwCOtherDateDQ DwCSciNameDQDefaults)");
