...
public class Runner {
	...
	public static void main( String[] args ) {
		...
		options.addOption("c","classes",true,"Comma separated list of classes containing test implementations to validate against the test data (default DwCMetadataDQDefaults,DwCGeoRefDQDefaults,DwCEventDQDefaults,DwCOtherDateDQ,DwCSciNameDQDefaults)");
